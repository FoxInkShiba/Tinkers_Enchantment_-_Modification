...
public class ConfigHandler {
    ...
    public static boolean mattockEnhance = true;
    ...
    public static float warpingSpeedDivisor = 10.0f;
    public static int strafeReductionPerLevel = 3;
    ...
    public static void syncConfig() {
        ...
        strafeReductionPerLevel = config.getInt("strafeReductionPerLevel", "damage", 5, 0, 100,
                "扫射附魔每级减少的拉弓时间（tick），0=无效，数值越大拉得越快");
        ...
        damageDecayCap = config.getFloat("damageDecayCap", "decay", 25.0f, 0.0f, 3276700f,
                "匠魂伤害衰减上限\nDamage decay cap");
        mattockEnhance = config.getBoolean("mattockEnhance", "general", true,
                "强化鹤嘴锄，使其能挖掘所有斧、铲、锄能挖的方块\n" +
                        "Enhance Mattock to mine all blocks that axe, shovel or hoe can mine");
